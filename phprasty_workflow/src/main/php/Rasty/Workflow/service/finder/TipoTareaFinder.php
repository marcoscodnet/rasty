...
/**
 * 
 * Finder para TipoTarea.
 * 
 * @author Bernardo
 * @since 04/09/2015
 */
class TipoTareaFinder implements  IAutocompleteFinder {
	...
	public function getAttributes(){
		return array("nombre", "descripcion");
	}
	...
	public function getAttributesCallback(){
		return array("codigo", "nombre", "descripcion");		
	}
	...
	function getEntityLabel( $entity ){
		if( !empty( $entity)  )
		return Locale::localize( $entity->getNombre() );
	}
